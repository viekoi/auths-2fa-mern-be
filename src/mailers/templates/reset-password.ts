interface IResetPasswordMailTemplate {
  userEmail: string;
  emailSubject: string;
  userName: string;
...
export const resetPasswordMailTemplate = (data: IResetPasswordMailTemplate) => {
        ...
        <body>
            <div class="email-wrapper">
                ...
                <div class="email-body">
                    ...
                    <p>Please confirm this link within 60 minutes</p>
                </div>
