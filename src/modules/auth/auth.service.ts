...
import { sendMail } from "../../mailers/send-mail";
import { accountActivationMailTemplate } from "../../mailers/templates/account-activation";
import { resetPasswordMailTemplate } from "../../mailers/templates/reset-password";
...
export class AuthService {
  public async register(registerData: RegisterDto) {
    ...
    const template = accountActivationMailTemplate({
      activationLink: verificationUrl,
      emailSubject: `An activation link has been sent to ${newUser.email}. Please check it with in 40 minutes`,
  ...
  public async forgotPassword(email: string) {
    ...
    const template = resetPasswordMailTemplate({
